				...
				<ul>
					...
					switch ($theme[6]){
						...
						case 2:
							...
							break;
						case 3:
							echo "<div class='logo'><img src='imgs/yellow.png'/></div>";
							break;
						case 4:
							echo "<div class='logo'><img src='imgs/green.png'/></div>";
							break;
						case 5:
				...
				for ($j=0; $j <= 4; $j++){
					...
					$sql="SELECT * FROM post where PID='$i'";
						if(!mysqli_query($con, $sql)){
							die('Well...F*ck'. mysqli_error($con));
						}
					...
					if ($array[5]=='post'){
						...
						echo "<div class='body'>" . "<h2>" . $array[1] . " : " . $array[2] . "</h2></br>" . "<p>" . $array[4] . " : " . " #" . $array[0] . " . " . $array[6] . "</p><div class='editor'><form method='post' action='poll.php'><input type='radio' name='ans' value='1'>". $array[7] . "</br><input type='radio' name='ans' value='2'>" . $array[8] . "</br><input type='radio' name='ans' value='3'>". $array[9] . "</br><input type='radio' name='ans' value='4'>". $array[10] . "</br>What is the #?<input type='number' name='PID' min='0'/><input type='submit' name='submit' value=' '/></br></form></div></div>";	
					}
				}
